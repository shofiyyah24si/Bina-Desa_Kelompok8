...
@section('title', 'Distribusi Logistik')
    ...
    <div class="header-section">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            <div>
                ...
                <p class="page-subtitle mb-0">Kelola distribusi dan penyaluran bantuan logistik</p>
            </div>
            ...
            <tbody>
                @forelse ($data as $row)
                    <tr>
                        ...
                        <td>
                            <span style="background: rgba(34, 197, 94, 0.1); color: #16a34a; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 600;">
                                📦 {{ $row->jumlah }}
                            </span>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-1">
                                <a href="{{ route('distribusi.show', $row->distribusi_id) }}"
                                ...
                                <a href="{{ route('distribusi.edit', $row->distribusi_id) }}"
                                ...
                                <form action="{{ route('distribusi.destroy', $row->distribusi_id) }}"
                ...
                @empty
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 60px 20px; color: #64748b;">
                            <i class="fas fa-truck" style="font-size: 64px; color: #cbd5e1; margin-bottom: 16px;"></i>
                            <h5>Belum Ada Data Distribusi</h5>
                            <p style="margin-bottom: 0;">Mulai tambahkan data distribusi dengan klik tombol "Tambah Distribusi Baru" di atas</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
